...
const MealDataLocal = () => {
  ...
  return (
    <div className="container shadow-2xl mt-3 rounded-xl bg-slate-100 mx-auto p-4 md:p-8 lg:p-12 xl:p-16">
      {recipe && (
        <>
          <div className="md:flex">
            ...
            <div className="md:ml-8">
              <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4">Recipe Details</h1>
              <h2 className="text-lg md:text-2xl lg:text-3xl font-bold mb-2">Name: {recipe.name}</h2>
              <div>
                <h3 className="text-md md:text-xl lg:text-2xl font-bold mb-2">Ingredients</h3>
              ...
              <h3 className="text-md md:text-xl lg:text-2xl font-bold mb-2">Instructions</h3>
              <p className="text-sm md:text-base lg:text-lg text-gray-700 mb-4">{recipe.instructions}</p>
              {recipe.youtubeLink && (
                <a
